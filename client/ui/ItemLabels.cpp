...
const std::vector<KindRange>& kind_ranges() {
    ...
    static const std::vector<KindRange> ranges = {
            ...
            {static_cast<uint8_t>(I::SIMPLE_BOW), static_cast<uint8_t>(I::COMPOUND_BOW),
             "Arma Ranged"},
            {static_cast<uint8_t>(I::ELVEN_FLUTE), static_cast<uint8_t>(I::NUDOSO_STAFF),
             "Arma Mágica"},
            {static_cast<uint8_t>(I::LEATHER_ARMOR), static_cast<uint8_t>(I::PALADIN_ROYAL_ARMOR),
             "Armadura"},
            {static_cast<uint8_t>(I::HOOD), static_cast<uint8_t>(I::MAGIC_HAT), "Casco"},
            {static_cast<uint8_t>(I::TURTLE_SHIELD), static_cast<uint8_t>(I::BOCA_SHIELD),
             "Escudo"},
            {static_cast<uint8_t>(I::HEALTH_POTION), static_cast<uint8_t>(I::MANA_POTION),
             "Poción"},
