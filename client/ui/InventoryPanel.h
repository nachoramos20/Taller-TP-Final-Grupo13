...
public:
    InventoryPanel(SDL2pp::Renderer& renderer, const std::string& font_path, int font_size = 11,
    ...
    void update(const uint8_t inventory[SnapshotDTO::INVENTORY_SIZE], uint8_t equipped_weapon_slot,
