...
int Camera::world_to_screen_x(float world_x) const { return static_cast<int>(world_x - _x); }

int Camera::world_to_screen_y(float world_y) const { return static_cast<int>(world_y - _y); }
...
void Camera::set_tile_size(int tile_size) { _tile_size = tile_size; }
