...
struct HeadLayout {
    ...
    static HeadLayout for_sprite(uint8_t sprite_id) {
        switch (sprite_id) {
            ...
            case 2: return {19, {0,21,42,63}, {21,21,21,21}, {11,14,14,14}, {0,0,0,0}, 1.0f};   // elfo
            case 3: return {17, {0,20,40,60}, {20,20,20,20}, {21,23,24,24}, {0,0,0,0}, 0.75f};  // enano
            case 4: return {17, {0,25,50,75}, {25,25,25,25}, {16,18,24,23}, {0,-1,0,0}, 1.0f};  // gnomo
            default: return {15, {0,21,42,63}, {21,21,21,21}, {11,14,11,11}, {0,0,0,0}, 1.0f};
        }
    }
};