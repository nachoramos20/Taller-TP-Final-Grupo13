...
void ClientProtocol::send_pick_item() { send_uint8(static_cast<uint8_t>(MsgType::PICK_ITEM)); }
...
void ClientProtocol::send_meditate() { send_uint8(static_cast<uint8_t>(MsgType::MEDITATE)); }

void ClientProtocol::send_resurrect() { send_uint8(static_cast<uint8_t>(MsgType::RESURRECT)); }
...
void ClientProtocol::send_logout() { send_uint8(static_cast<uint8_t>(MsgType::LOGOUT)); }
...
MsgType ClientProtocol::recv_opcode() { return static_cast<MsgType>(recv_uint8()); }

uint16_t ClientProtocol::recv_login_ok() { return recv_uint16(); }

std::string ClientProtocol::recv_login_error() { return recv_string(); }
