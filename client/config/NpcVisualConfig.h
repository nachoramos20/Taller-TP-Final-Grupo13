...
struct NpcSheetVariant {
    ...
    std::string death_sound_key;  // clave en AudioConfig::creature_sounds (vacío = sin sonido de
                                  // muerte)
};
...
public:
    ...
    const NpcSheetVariant& select_variant(uint8_t npc_sprite_id, uint16_t entity_id,
