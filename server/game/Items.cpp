...
static const std::unordered_map<uint8_t, ItemDef>& catalog() {
    static const std::unordered_map<uint8_t, ItemDef> c = {
        // id, kind, name, min, max, mana, range
        ...
        {(uint8_t)ItemId::ELVEN_FLUTE,   {ItemId::ELVEN_FLUTE,   ItemKind::WEAPON_RANGED, "Flauta Elfica",     6, 15,  8, 7}},
        {(uint8_t)ItemId::GEMMED_STAFF,  {ItemId::GEMMED_STAFF,  ItemKind::WEAPON_RANGED, "Baculo Engarzado", 10, 22, 12, 6}},
        ...
        {(uint8_t)ItemId::MAGIC_HAT,     {ItemId::MAGIC_HAT,     ItemKind::HELMET, "Sombrero Magico",    1, 3, 0, 0}},
        ...
        {(uint8_t)ItemId::HEALTH_POTION, {ItemId::HEALTH_POTION, ItemKind::POTION, "Pocion de Vida",    30, 30, 0, 0}},
        {(uint8_t)ItemId::MANA_POTION,   {ItemId::MANA_POTION,   ItemKind::POTION, "Pocion de Mana",    30, 30, 0, 0}},
...
EquipSlot equip_slot_for(ItemKind kind) {
    switch (kind) {
        ...
        case ItemKind::WEAPON_RANGED: return EquipSlot::WEAPON;
