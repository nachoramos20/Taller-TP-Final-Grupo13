...
void WorldBuilder::configure_dungeon(World& world) {
    static const std::vector<NpcId> dungeon_types = {NpcId::GOBLIN, NpcId::SKELETON, NpcId::ZOMBIE,
