...
uint16_t WorldCollision::get_width() const { return width; }

uint16_t WorldCollision::get_height() const { return height; }

bool WorldCollision::in_bounds(uint16_t x, uint16_t y) const { return x < width && y < height; }
